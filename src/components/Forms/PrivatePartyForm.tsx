          ...
          <div className="control">
            ...
            <div className="select">
              <select
                ...
                onChange={(e: ChangeEvent<HTMLSelectElement>) => setInsideOrOutside(e.target.value)}
              >
          ...
          <div className="control">
            ...
            <div className="select">
              <select
                ...
                required
                value={openOrCash}
                onChange={(e: ChangeEvent<HTMLSelectElement>) => setOpenOrCash(e.target.value)}
              >
            ...
            <div className="field">
              <p className="control is-expanded">
                <textarea
                  ...
                  value={occassion}
                  onChange={(e: ChangeEvent<HTMLTextAreaElement>) => setOccassion(e.target.value)}
                />
              </p>
            </div>
          </div>
